<template>
  <div>
    <banner></banner>
    <div class="main">
      <!--start: blip aims to democratize energy storage while lowering your carbon footprint  -->
      <section class="blipAims">
        <b-row class="w-100p t-left">
          <b-col xs="12" sm="12" md="6" lg="6" xl="6" class="left t-left b-DEF5FF">
            <b-row class="w-90p insider t-left">
              ...
              <h2 class="h2point8 c-254B77 f-weight-400 m-l-0 p-l-0 t-left" style="margin-bottom: 50px">blip aims to democratize energy storage while lowering your carbon footprint</h2>
              <p class="p3 c-183B56 m-l-0 p-l-0 t-left">
                blip aims to democratize energy storage while lowering your carbon footprint - one renter at a time
              </p>
            </b-row>
          </b-col>
      ...
      <!--end: blip aims to democratize energy storage while lowering your carbon footprint-->
      ...
      <!--end: We care deeply about our environment-->
